...
add("Jonathan Rouach",("Zcash Shielded Assets - Asset Swaps and Beyond","QEDIT","Named in the proposal team ('Pablo Kogan, Alexey Koren, Constance Beguier, Eran Tromer, Jonathan Rouach, Antoine Rondelet and Vivek Arte')",F+"zcash-shielded-assets-asset-swaps-and-beyond/44497","May 2023","Completed"))
add("Jonathan Rouach",
...
add("Kit Sturgeon (mrkit2u on the forum)",
 ("Zcash-Avalanche Elastic Subnet Bridge","red·dev (RedDev)","Applicant (thread author mrkit2u, display name Kit Sturgeon; forum bio 'CEO and founder of red·dev')",F+"zcash-elastic-subnet-bridge-on-avalanche/44220","May 2023","Open"),
...
add("Mark Henderson",("Ziggurat 1.0 / 2.0 / 3.0; Zcash UniFFI Library","Equilibrium","Applicant (forum shieldedmark = Mark Henderson, VP Engineering; 'Hey everybody, Mark here from Equilibrium' in the Ziggurat 2.0 thread 41201); GitHub aphelionz",F+"ziggurat-the-zcash-network-stability-framework/38758","Mar 2021","Completed"))
...
add("Pablo K",("Zcash Shielded Assets - Asset Swaps and Beyond","QEDIT","Named in the proposal team ('Pablo Kogan, Alexey Koren, Constance Beguier, Eran Tromer, Jonathan Rouach, Antoine Rondelet and Vivek Arte')",F+"zcash-shielded-assets-asset-swaps-and-beyond/44497","May 2023","Completed"))
...
add("Vivek Arte",
 ("Zcash Shielded Assets - Asset Swaps and Beyond","QEDIT","Applicant (thread author vivek: '... and Vivek Arte (myself)')",F+"zcash-shielded-assets-asset-swaps-and-beyond/44497","May 2023","Completed"),
 ("Assistance for Legal Compliance Activities (2024); User-Control for ZSAs","QEDIT","Applicant (thread author vivek on both)",F+"assistance-with-legal-compliance-costs/47824","Jul 2024","Completed"),
 ("Zebra ZSA Integration; ZSAs in NU7; Legal Compliance 2025; OrchardZSA finalization; Feature Branch Testnet","QEDIT","Application owner / author @vivek-arte on all five",GH+"6","Jan 2025","Completed/Open"))
...
add("zksquirrel",
 ("Community Note Taker","Jason Rogers","Grantee ('Jason Rogers will be attending the bi-weekly Arborist calls', linked to twitter.com/zksquirrel; forum squirrel)",F+"rfp-community-note-taker/41656","Jul 2022","Completed"),
...
add("Aura Brito (AuraBritoSM on the forum)",
 ...
 ("Zk Av Club 2025; Community Media Infrastructure 2026","ZK AV Club","Named team member (Curriculum; Community Workshops Coordinator)",GH+"11","Feb 2025","Completed/Open"))
add("Constance Beguier",("Zcash Shielded Assets - Asset Swaps and Beyond","QEDIT","Named in the proposal team ('Pablo Kogan, Alexey Koren, Constance Beguier, Eran Tromer, Jonathan Rouach, Antoine Rondelet and Vivek Arte')",F+"zcash-shielded-assets-asset-swaps-and-beyond/44497","May 2023","Completed"))
...
add("Juan Carlos Carmona Calvo (Juanky on the forum)",("Implement Orchard Funded Amendment; Zingo! Onward","Zingo Labs","Named team ('Now there are 3 of us (Za, Juanky, Gygaxis)', thread 42706; applicants incl. juanky@zingolabs.org in thread 43945; 'Juanky - TypeScript, FrontEnd, UX/UI' in thread 42371); forum title Zingo Labs",F+"implement-orchard/42706","Nov 2022","Completed"))
...
add("Minevg (on the forum)",
 ...
 ("Zcash Brazil 2026","Zcash Brazil","Team member per milestone reports ('Design Team @iogy & @Minevg'); application names no individuals",F+"53702/14","Jan 2026","Open"))
add("Patrick  Diniz ",("Zcash Brazil 2026","Zcash Brazil","Paid partner per 2026 milestone reports ('we\'ve signed a deal with him until December, he\'s a new partner/contributor'; listed monthly); identity via the report\'s Instagram link (bio \'Patrick Diniz\')",F+"53702/17","Feb 2026","Open"))
...
add("Rodrigo Schönell",("Zcash Brazil 2026","Zcash Brazil","Team member per 2026 milestone reports ('Marketing & Growth - Michae2xl, Amandita, schonell ...'; '@Schönell: Former Community Manager at CoinEx Brazil'; 'Event management: Schonell'); application names no individuals",F+"53702/14","Jan 2026","Open"))
